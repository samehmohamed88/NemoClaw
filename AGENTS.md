...
- After changing docs, run the conversion dry run:

  ```bash
  python3 scripts/docs-to-skills.py docs/ .agents/skills/ --prefix nemoclaw-user --dry-run
  ```

- Do not include generated `.agents/skills/nemoclaw-user-*` updates in normal docs PRs; the Docs to Skills workflow syncs them after merge.
